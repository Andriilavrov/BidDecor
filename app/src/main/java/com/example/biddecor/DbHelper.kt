...
class DbHelper(val context: Context, factory: SQLiteDatabase.CursorFactory?) :
    ...
    fun testFillDB() {
        ...
        addLot(Lot(null, 1, null, 1920, null, "Вінтажний дерев'яний стілець", "Цей вінтажний дерев'яний стілець додає шарму будь-якому інтер'єру. Виготовлений " +
        ...
        addLot(Lot(null, 1, null, 1920, null, "Класичний дубовий обідній стіл", "Цей класичний дубовий обідній стіл втілює елегантність і міцність. " +
